...
?>
                <tr>
					...
					<td align="center">
                       <a href="modifier_adrare.php?edit_id=<?php print($row['id']); ?>" class="btn btn-primary mb-2 btn-success" onclick="return confirm('Êtes-vous sûr de vouloir modifier ce PERSONE  ?');">
				       <font color ="white">Modifier <?php echo "<img src='edit.jpg' width=10% height=10%>"; ?></font></a>
                     </td>
                    <td align="center">
                       <a href="supprimer_du_list_adrare.php?delete_id=<?php print($row['id']); ?>" class="btn btn-primary mb-2 btn-success" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce PERSONE ?');">
