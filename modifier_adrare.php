...
$sql= "select * from adrare where id='$id' ";
...
// stocker une requéte sql pou la modification dans une variable 
	$sql= "update  adrare set nom='$nom ',prenom='$Prenom',famile='$Famile',travaille='$Travaille',ville='$Ville',duplome='$Duplome',age='$Age', tel ='$tel' where id='$id' ";
// stocke de la resultat du fonction mysqli_query qui prendre deux paramaitre 
//1- la variable qui contien la connection avec la base de donnees 
...
<div><B><I><h1>MODIFICATION DE PERSONE DU ADARARE</h1></I></B></div><br><br><br>
