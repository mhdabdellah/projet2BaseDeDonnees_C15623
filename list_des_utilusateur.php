...
?>
    <div class="block">
        <h1><B><i>LISTE DE INCHIRRI</i></B></h1>
...
?>
                <tr>
					...
					<td align="center">
                       <a href="modifier_utilisateur.php?edit_id=<?php print($row['id']); ?>" class="btn btn-primary mb-2 btn-success" onclick="return confirm('Êtes-vous sûr de vouloir modifier ce PERSONE  ?');">
				       <font color ="white">Modifier <?php echo "<img src='edit.jpg' width=10% height=10%>"; ?></font></a>
                     </td>
                    <td align="center">
                       <a href="supprimer_utilisateur.php?delete_id=<?php print($row['id']); ?>" class="btn btn-primary mb-2 btn-success" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce PERSONE ?');">
